...
def detect_bottlenecks(past_data, future_data):
    ...
    if current_cpu_peak >= critical_threshold:
        ...
        current_bottlenecks.append(f" WARNING: Current CPU peaked at {current_cpu_peak}%")
    elif current_cpu_peak >= notice_threshold:
        current_bottlenecks.append(f" NOTICE: Current CPU peaked at {current_cpu_peak}%")
    ...
    if current_mem_peak >= critical_threshold:
        ...
        current_bottlenecks.append(f" WARNING: Current Memory peaked at {current_mem_peak}%")
    elif current_mem_peak >= notice_threshold:
        current_bottlenecks.append(f" NOTICE: Current Memory peaked at {current_mem_peak}%")
